      ...
      <View style={{flex: 1}}>
        <View style={{flex: 2, flexDirection: 'row'}}>
          ...
          <View style={{flex: 8, flexDirection: 'column'}}>
            <Text style={{fontSize: 12,marginLeft: 10,marginTop: 15,color: '#034423',fontSize: 25}}>Hello</Text>
            <Text style={{fontSize: 12,marginLeft: 10,color: '#026234'}}>Please confirm payment of ticket with Momo.</Text>
          </View>
